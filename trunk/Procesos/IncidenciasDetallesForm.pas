...
type
  TfrmIncidenciasDetalles = class(T_frmGrid)
    ...
    tvMasterIdIncidenciaEstatus: TcxGridDBColumn;
...
uses IncidenciasDM, IncidenciasDetallesEdit;

procedure TfrmIncidenciasDetalles.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm:= TfrmIncidenciaDetallesEdit.Create(Self);
end;
