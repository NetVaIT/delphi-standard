...
type
  TfrmRegimenFiscales = class(T_frmGrid)
...
uses RegimenFiscalDM, RegimenFiscalForm;

procedure TfrmRegimenFiscales.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm:= TfrmRegimenFiscal.Create(Self);
end;
