...
type
  TfrmEmpleados = class(T_frmGrid)
    tvMasterIdPersonaRol: TcxGridDBColumn;
    tvMasterIdPerfilPago: TcxGridDBColumn;
    tvMasterNSS: TcxGridDBColumn;
    tvMasterFechaIngresoIMSS: TcxGridDBColumn;
...
uses EmpleadosDM, EmpleadosEdit;

procedure TfrmEmpleados.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm:= TfrmEmpleadosEdit.Create(Self);
end;
