...
type
  TfrmPersonasCSD = class(T_frmGrid)
...
uses PersonasCSDDM, PersonasCSDEdit;

procedure TfrmPersonasCSD.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm:= TfrmPersonasCSDEdit.Create(Self);
end;
