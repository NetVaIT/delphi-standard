inherited frmEsquemaPagosPersonas: TfrmEsquemaPagosPersonas
  Caption = 'frmEsquemaPagosPersonas'
  OnCreate = FormCreate
  ExplicitWidth = 651
  ExplicitHeight = 457
  PixelsPerInch = 96
  ...
  inherited pnlMaster: TPanel
    inherited cxGrid: TcxGrid
      inherited tvMaster: TcxGridDBTableView
        object tvMasterIdEsquemaPagoPersona: TcxGridDBColumn
          DataBinding.FieldName = 'IdEsquemaPagoPersona'
          Visible = False
        end
