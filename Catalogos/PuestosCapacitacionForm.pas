...
type
  TfrmPuestosCapacitacion = class(T_frmGrid)
    tvMasterIdPuestoCapacitacion: TcxGridDBColumn;
...
uses PuestosCapacitacionEditForm, PuestosCapacitacionDM;

procedure TfrmPuestosCapacitacion.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm:= TfrmPuestosCapacitacionEdit.Create(Self);
end;
