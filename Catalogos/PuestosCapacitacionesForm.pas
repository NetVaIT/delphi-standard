unit PuestosCapacitacionesForm;
...
type
  TfrmPuestosCapacitaciones = class(T_frmDualList)
    tvAviableIdBateriaCapacitacion: TcxGridDBColumn;
    tvAviableDescripcion: TcxGridDBColumn;
    tvAssignedIdBateriaCapacitacion: TcxGridDBColumn;
