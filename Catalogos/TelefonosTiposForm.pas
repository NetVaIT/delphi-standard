...
type
  TfrmTelefonosTipos = class(T_frmGrid)
...
uses TelefonosTipoForm, TelefonosTiposDM;

procedure TfrmTelefonosTipos.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm:= TfrmTelefonosTipo.Create(Self);
end;
