...
type
  TfrmPrestamosPago = class(T_frmGrid)
    tvMasterIdPrestamoPago: TcxGridDBColumn;
    tvMasterIdPrestamo: TcxGridDBColumn;
    ...
    tvMasterImporteCalculo: TcxGridDBColumn;
    tvMasterPorcentaje: TcxGridDBColumn;
    tvMasterImportePeriodo: TcxGridDBColumn;
...
uses PrestamosPagoDM, PrestamosPagoEdit;

procedure TfrmPrestamosPago.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm:= TfrmPrestamosPagoEdit.Create(Self);
end;
