...
uses
  ...
  Vcl.ExtCtrls, Vcl.Grids, Vcl.DBGrids, cxGridBandedTableView,
...
type
  ...
  private
    ...
    FGeneraReporte: TBasicAction;
    procedure SetGeneraReporte(const Value: TBasicAction);
  public
    { Public declarations }
    property GeneraReporte: TBasicAction read FGeneraReporte write SetGeneraReporte;
  end;
